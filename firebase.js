...
function reset(){
  ...
  <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="datetime-local" id="deadlinezsm" placeholder="Gib hier das Deadlinedatum und die Deadlineuhrzeit(zB 22.10.2020T22:00)" class="form-control form-control-sm">
